...
BODY {
	COLOR: black
			...
			<body>
				<div align="center">
					<table class="xdFormLayout" style="BORDER-TOP-STYLE: none; WORD-WRAP: break-word; BORDER-LEFT-STYLE: none; WIDTH: 629px; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM-STYLE: none; BORDER-RIGHT-STYLE: none">
						<colgroup>
						...
						<tbody>
							...
							<tr class="xdTableContentRow">
								<td vAlign="top" class="xdTableContentCell">
									<div>
										<font size="2"><span title="" class="xdTextBox" hideFocus="1" xd:xctname="PlainText" xd:CtrlId="CTRL1" xd:binding="my:testInput" tabIndex="0" style="WIDTH: 100%">
